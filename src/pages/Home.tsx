...
const Home = () => {
  ...
  return (
    ...
    <WelcomePopup /> 
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-primary/10 via-blue-50 to-primary/5 py-8 md:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" asChild className="w-full sm:w-auto focus:ring-2 focus:ring-primary">
  ...
  {/* <div className="p-6 bg-white">
    ...
    <p className="text-sm text-gray-600 mt-2">Where ideas meet execution</p>
      ...
      <section className="py-8 md:py-20 bg-gray-900 text-white">
        <div className="container-width section-padding">
          <div className="text-center mb-16">
  ...
  <Card key={product.id} className="h-full hover:shadow-lg transition-shadow bg-gray-800 border-gray-700 text-white">
    ...
    <CardContent>
      ...
      <section className="py-8 md:py-20 bg-gradient-to-br from-blue-600 via-primary to-cyan-500 text-white relative overflow-hidden">
  ...
  {/* Collaborators Section */}
      ...
      {/* CTA Section */}
      <section className="py-8 md:py-20 bg-primary text-white">
